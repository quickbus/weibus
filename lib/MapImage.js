...
MapImage.prototype.showMarker = function(marker, zoomLevel) {
  ...
  return this.showMarkerWithIndex(marker, index, zoomLevel);
};

MapImage.prototype.showMarkerWithIndex = function(marker, index, zoomLevel) {
  ...
  var pathString = 'pathStyles=0xff0000,5,1&paths=' + this.points.map(
    function(
      point) {
  ...
  return APIURL + [size, pathString, labelString, styleString,
