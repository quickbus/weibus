...
var templates = require('./temmplateConfig.json');
...
var picUrlCompiler = lo.template(templates.thumbTemplate);
...
module.exports = function(robot) {
  ...
  robot.set('query by nick name direct', {
    ...
    handler: function(info, next) {
      var res = {};
      formpost(
          'http://42.121.133.161/ViewUserLatestPositions/wechat_latest_position_by_name', {
        ...
        .then(function(reses) {
          ...
          res = {
            ...
            updateAT: obj.ViewUserLatestPosition.modified,
            name: obj.ViewUserLatestPosition.route_name
          };
          return res;
        })
        .then(function(res) {
