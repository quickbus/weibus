...
var assembleMessage = function(res) {
  ...
  return baiduapi.toBaiduCoordsQ(res.gpsLng, res.gpsLat,
    ...
    .then(function(pos) {
      ...
      return baiduapi.getPOI(pos.lng,
        pos.lat, '1wpk9X6wAbE9D2pHZRYNhmLw');
    })
    .then(function(pois_info) {
      var message = {
        ...
        description: pois_info.address + '(' + pois_info.pois[0].name + ' 附近' + ')' + '\n' +
          '阅读全文查看更多优惠信息',
        url: 'http://mp.weixin.qq.com/s?__biz=MzA5MjczNzMzOA==&mid=202552420&idx=2&sn=8fe883a56b8099550f2cf5d4b675dfec#rd'
      };
      return message;
    });
